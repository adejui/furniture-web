        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0 mb-3 d-flex justify-content-between align-items-center">
                    <h6 class="mb-0 fs-4 fw-bolder">Daftar Diskon</h6>
                            ...
                            <tbody>
                                @forelse ($discounts as $discount)
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $discount->formatted_value }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $discount->start_date }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $discount->end_date }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="{{ $discount->is_active ? 'text-success' : 'text-danger' }} text-xs fw-bold">
                                                {{ $discount->is_active ? 'Berlaku' : 'Kadaluarsa' }}
                                            </span>
                                        </td>
